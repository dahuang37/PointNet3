...
from models import LSTM_dropout
...
train_loader = DataLoader(ModelNetDataset(root, train=True), batch_size=opt.batchSize,
                       shuffle=True, num_workers=opt.workers)
test_loader = DataLoader(ModelNetDataset(root, train=False), batch_size=opt.batchSize,
                       shuffle=True, num_workers=opt.workers)
